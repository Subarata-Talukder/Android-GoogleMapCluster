...
/**
 * Created by Subarata Talukder on 3/20/2017.
 */
...
public class MapsUI extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onStart() {
        super.onStart();
        Intent geoServiceIntent = new Intent(MapsUI.this, GeoService.class);
        // Start the service first
        startService(new Intent(MapsUI.this, GeoService.class));
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng dhaka = new LatLng(23.810332, 90.412518);
        createMarker(mMap, dhaka);
        ...
        mClusterManager.setRenderer(new CustomClusterRender(MapsUI.this, googleMap, mClusterManager));
